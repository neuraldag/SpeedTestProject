...
class GaugeView: UIView {
    ...
    var outerCenterDiscWidth: CGFloat = 0
    var innerCenterDiscColor = UIColor.systemYellow
    var innerCenterDiscWidth: CGFloat = 10
    ...
    var needleColor = UIColor.systemYellow
    ...
    func setUp() {
        ...
        needle.bounds = CGRect(x: 0, y: 0, width: needleWidth, height: bounds.height / 2.1)
